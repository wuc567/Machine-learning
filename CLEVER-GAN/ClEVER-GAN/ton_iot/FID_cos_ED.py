...
# data_generate = pd.read_csv('D:/python/pythonProject/PHDfirstTest/ton_iot/vae_generated_data.csv', encoding='utf-8',
#                             low_memory=False, header=None, dtype='float64')

# data_generate = pd.read_csv('D:/python/pythonProject/PHDfirstTest/ton_iot/vae_gan_contra_lossMethod_generated_data.csv', encoding='utf-8',
#                             low_memory=False, header=None, dtype='float64')


# data_generate = pd.read_csv('D:/python/pythonProject/PHDfirstTest/ton_iot/vae_gan_generated_data.csv', encoding='utf-8',
#                             low_memory=False, header=None, dtype='float64')

# data_generate = pd.read_csv('D:/python/pythonProject/PHDfirstTest/ton_iot/vae_gan_contra_generated_data.csv', encoding='utf-8',
#                             low_memory=False, header=None, dtype='float64')


data_generate = pd.read_csv('D:/python/pythonProject/PHDfirstTest/ton_iot/GAN_generated_data.csv', encoding='utf-8',
                            low_memory=False, header=None, dtype='float64')
...
# text_Result = data_text[data_text[:, -1] == target_value]
#
