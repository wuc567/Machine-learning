...
data_fu = pd.read_csv('D:/python/pythonProject/PHDfirstTest/ton_iot/datasets_ton_iot_afterProcess.csv',
                      encoding='utf-8',
                      low_memory=False)
...
data_fu = filtered_data
print(f"data_fu形状：{data_fu.shape}")
# ----------------------------------------------------------------------------------------------------------------------------

# data_fu_x = data_fu[:20657, :-1]  # 标签为7
# data_fu_y = data_fu[:20657, -1]  # 标签为7

# data_fu_x = data_fu[:19964, :-1]  # 标签为6
# data_fu_y = data_fu[:19964, -1]  # 标签为6

# data_fu_x = data_fu[:14376, :-1]  # 标签为5
# data_fu_y = data_fu[:14376, -1]  # 标签为5

# data_fu_x = data_fu[:18600, :-1]  # 标签为4
# data_fu_y = data_fu[:18600, -1]  # 标签为4

data_fu_x = data_fu[:19998, :-1]  # 标签为2
data_fu_y = data_fu[:19998, -1]  # 标签为2

# data_fu_x = data_fu[:13617, :-1]  # 标签为1
# data_fu_y = data_fu[:13617, -1]  # 标签为1

# data_fu_x = data_fu[:19695, :-1]  # 标签为0
# data_fu_y = data_fu[:19695, -1]  # 标签为0
# ----------------------------------------------------------------------------------------------------------------------------
...
for epoch in range(epochs):
    ...
    # 4. 计算对比损失（这里是对比损失）
    cos_loss = contrastive_loss(z_real, z_generated, z_negative)
    ...
    loss_cos_vae = loss_generator_vae + loss_generator_gan + cos_loss
    ...
    if len(loss1_history) == patience and all(x >= loss1_history[0] for x in loss1_history[1:]):
        alpha = alpha * 0.99  # 如果 loss1 没有下降，alpha 减少
        if alpha < 0.2:
            alpha = 0.2
    ...
    vae_cos_losses.append(loss_cos_vae.item() / 100)
...
np.savetxt(
    'D:/python/pythonProject/PHDfirstTest/ton_iot/CVG_TRUE_noStrategy/2_7308_best_vae_gan_contra_generated_data.csv',
