...
np.savetxt('2_class_data.csv', data_final, delimiter=',')
...
#         np.savetxt('3_vae_generated_data.csv', generated_data_numpy, delimiter=',')
#         data_generate = pd.read_csv(
#             'D:/python/pythonProject/PHDfirstTest/x_iiot/3_vae_generated_data.csv', encoding='utf-8',
...
#
#             np.savetxt('3_best_vae_generated_data.csv', generated_data_numpy, delimiter=',')
#
#             # # 保存模型，保存模型的状态字典
...
# #
# #
# # np.savetxt('1000_vae_generated_data.csv', generated_data_numpy, delimiter=',')
#
# #
#
