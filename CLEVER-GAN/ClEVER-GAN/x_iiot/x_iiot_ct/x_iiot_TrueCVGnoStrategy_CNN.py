...
set_seed(1)  # 设置为固定的随机种子，例如42

dataset = pd.read_csv('D:/python/pythonProject/PHDfirstTest/x_iiot/datasets_xiiot_afterProcess.csv', encoding='utf-8',
                      low_memory=False)
#
# dataset_9 = pd.read_csv('/x_iiot/little_class_data.csv', encoding='utf-8',
#                         low_memory=False)

dataset_gen_9 = pd.read_csv(
    'D:/python/pythonProject/PHDfirstTest/x_iiot/CVG_TRUE_noStrategy/9_5960_best_vae_gan_contra_generated_data.csv',
    encoding='utf-8',
    low_memory=False)
dataset_gen_8 = pd.read_csv(
    'D:/python/pythonProject/PHDfirstTest/x_iiot/CVG_TRUE_noStrategy/8_1069_best_vae_gan_contra_generated_data.csv',
    encoding='utf-8',
    low_memory=False)
dataset_gen_7 = pd.read_csv(
    'D:/python/pythonProject/PHDfirstTest/x_iiot/CVG_TRUE_noStrategy/7_2632_best_vae_gan_contra_generated_data.csv',
    encoding='utf-8',
    low_memory=False)
dataset_gen_6 = pd.read_csv(
    'D:/python/pythonProject/PHDfirstTest/x_iiot/CVG_TRUE_noStrategy/6_842_best_vae_gan_contra_generated_data.csv',
    encoding='utf-8',
    low_memory=False)
dataset_gen_5 = pd.read_csv(
    'D:/python/pythonProject/PHDfirstTest/x_iiot/CVG_TRUE_noStrategy/5_1511_best_vae_gan_contra_generated_data.csv',
    encoding='utf-8',
    low_memory=False)
dataset_gen_4 = pd.read_csv(
    'D:/python/pythonProject/PHDfirstTest/x_iiot/CVG_TRUE_noStrategy/4_713_best_vae_gan_contra_generated_data.csv',
    encoding='utf-8',
    low_memory=False)
dataset_gen_3 = pd.read_csv(
    'D:/python/pythonProject/PHDfirstTest/x_iiot/CVG_TRUE_noStrategy/3_5154_best_vae_gan_contra_generated_data.csv',
    encoding='utf-8',
    low_memory=False)
dataset_gen_1 = pd.read_csv(
    'D:/python/pythonProject/PHDfirstTest/x_iiot/CVG_TRUE_noStrategy/1_3970_best_vae_gan_contra_generated_data.csv',
    encoding='utf-8',
    low_memory=False)
dataset_gen_0 = pd.read_csv(
    'D:/python/pythonProject/PHDfirstTest/x_iiot/CVG_TRUE_noStrategy/0_1939_best_vae_gan_contra_generated_data.csv',
    encoding='utf-8',
    low_memory=False)
