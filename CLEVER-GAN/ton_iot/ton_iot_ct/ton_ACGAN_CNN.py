...
set_seed(12345)  # 设置为固定的随机种子，例如42
...
dataset_gen_7 = pd.read_csv(
    'D:/python/pythonProject/PHDfirstTest/ton_iot/ACGAN/7_7783_acgan_generated_data.csv',
    encoding='utf-8',
    low_memory=False)
dataset_gen_6 = pd.read_csv(
    'D:/python/pythonProject/PHDfirstTest/ton_iot/ACGAN/6_7439_acgan_generated_data.csv',
    encoding='utf-8',
    low_memory=False)
dataset_gen_5 = pd.read_csv(
    'D:/python/pythonProject/PHDfirstTest/ton_iot/ACGAN/5_4912_acgan_generated_data.csv',
    encoding='utf-8',
    low_memory=False)
dataset_gen_4 = pd.read_csv(
    'D:/python/pythonProject/PHDfirstTest/ton_iot/ACGAN/4_6804_acgan_generated_data.csv',
    encoding='utf-8',
    low_memory=False)
dataset_gen_2 = pd.read_csv(
    'D:/python/pythonProject/PHDfirstTest/ton_iot/ACGAN/2_7308_acgan_generated_data.csv',
    encoding='utf-8',
    low_memory=False)
dataset_gen_1 = pd.read_csv(
    'D:/python/pythonProject/PHDfirstTest/ton_iot/ACGAN/1_4149_acgan_generated_data.csv',
    encoding='utf-8',
    low_memory=False)
dataset_gen_0 = pd.read_csv(
    'D:/python/pythonProject/PHDfirstTest/ton_iot/ACGAN/0_7397_acgan_generated_data.csv',
    encoding='utf-8',
    low_memory=False)
...
dataset_gen_2 = dataset_gen_2[:, 0:-1]
# 创建一个元素全为9的新列，行数与原数组匹配
