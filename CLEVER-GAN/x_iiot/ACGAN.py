...
label = filtered_rows[:, -2]

real_data = filtered_rows[:, 0:-3]
label = label.reshape(-1, 1)
real_data = np.hstack((real_data, label))
...
np.savetxt('D:/python/pythonProject/PHDfirstTest/x_iiot/ACGAN/0_1939_acgan_generated_data.csv', generated_data_numpy,
           delimiter=',')
