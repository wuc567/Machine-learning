...
dataset_gen_9 = pd.read_csv(
    'D:/python/pythonProject/PHDfirstTest/x_iiot/ACGAN/9_5960_acgan_generated_data.csv',
    encoding='utf-8',
    low_memory=False)
dataset_gen_8 = pd.read_csv(
    'D:/python/pythonProject/PHDfirstTest/x_iiot/ACGAN/8_1069_acgan_generated_data.csv',
    encoding='utf-8',
    low_memory=False)
dataset_gen_7 = pd.read_csv(
    'D:/python/pythonProject/PHDfirstTest/x_iiot/ACGAN/7_2632_acgan_generated_data.csv',
    encoding='utf-8',
    low_memory=False)
dataset_gen_6 = pd.read_csv(
    'D:/python/pythonProject/PHDfirstTest/x_iiot/ACGAN/6_842_acgan_generated_data.csv',
    encoding='utf-8',
    low_memory=False)
dataset_gen_5 = pd.read_csv(
    'D:/python/pythonProject/PHDfirstTest/x_iiot/ACGAN/5_1511_acgan_generated_data.csv',
    encoding='utf-8',
    low_memory=False)
dataset_gen_4 = pd.read_csv(
    'D:/python/pythonProject/PHDfirstTest/x_iiot/ACGAN/4_713_acgan_generated_data.csv',
    encoding='utf-8',
    low_memory=False)
dataset_gen_3 = pd.read_csv(
    'D:/python/pythonProject/PHDfirstTest/x_iiot/ACGAN/3_5154_acgan_generated_data.csv',
    encoding='utf-8',
    low_memory=False)
dataset_gen_1 = pd.read_csv(
    'D:/python/pythonProject/PHDfirstTest/x_iiot/ACGAN/1_3970_acgan_generated_data.csv',
    encoding='utf-8',
    low_memory=False)
dataset_gen_0 = pd.read_csv(
    'D:/python/pythonProject/PHDfirstTest/x_iiot/ACGAN/0_1939_acgan_generated_data.csv',
    encoding='utf-8',
    low_memory=False)
...
dataset_gen_9 = dataset_gen_9[:, 0:-1]
...
dataset_gen_8 = dataset_gen_8[:, 0:-1]
# 创建一个元素全为9的新列，行数与原数组匹配
...
dataset_gen_7 = dataset_gen_7[:, 0:-1]
# 创建一个元素全为9的新列，行数与原数组匹配
...
dataset_gen_6 = dataset_gen_6[:, 0:-1]
# 创建一个元素全为9的新列，行数与原数组匹配
...
dataset_gen_5 = dataset_gen_5[:, 0:-1]
# 创建一个元素全为9的新列，行数与原数组匹配
...
dataset_gen_4 = dataset_gen_4[:, 0:-1]
# 创建一个元素全为9的新列，行数与原数组匹配
...
dataset_gen_3 = dataset_gen_3[:, 0:-1]
# 创建一个元素全为9的新列，行数与原数组匹配
...
dataset_gen_1 = dataset_gen_1[:, 0:-1]
# 创建一个元素全为9的新列，行数与原数组匹配
...
dataset_gen_0 = dataset_gen_0[:, 0:-1]
# 创建一个元素全为9的新列，行数与原数组匹配
