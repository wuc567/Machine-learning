...
dataset_gen_9 = pd.read_csv(
    'D:/python/pythonProject/PHDfirstTest/x_iiot/WGAN/9_5960_wgan_generated_data.csv',
    encoding='utf-8',
    low_memory=False)
dataset_gen_8 = pd.read_csv(
    'D:/python/pythonProject/PHDfirstTest/x_iiot/WGAN/8_1069_wgan_generated_data.csv',
    encoding='utf-8',
    low_memory=False)
dataset_gen_7 = pd.read_csv(
    'D:/python/pythonProject/PHDfirstTest/x_iiot/WGAN/7_2632_wgan_generated_data.csv',
    encoding='utf-8',
    low_memory=False)
dataset_gen_6 = pd.read_csv(
    'D:/python/pythonProject/PHDfirstTest/x_iiot/WGAN/6_842_wgan_generated_data.csv',
    encoding='utf-8',
    low_memory=False)
dataset_gen_5 = pd.read_csv(
    'D:/python/pythonProject/PHDfirstTest/x_iiot/WGAN/5_1511_wgan_generated_data.csv',
    encoding='utf-8',
    low_memory=False)
dataset_gen_4 = pd.read_csv(
    'D:/python/pythonProject/PHDfirstTest/x_iiot/WGAN/4_713_wgan_generated_data.csv',
    encoding='utf-8',
    low_memory=False)
dataset_gen_3 = pd.read_csv(
    'D:/python/pythonProject/PHDfirstTest/x_iiot/WGAN/3_5154_wgan_generated_data.csv',
    encoding='utf-8',
    low_memory=False)
dataset_gen_1 = pd.read_csv(
    'D:/python/pythonProject/PHDfirstTest/x_iiot/WGAN/1_3970_wgan_generated_data.csv',
    encoding='utf-8',
    low_memory=False)
dataset_gen_0 = pd.read_csv(
    'D:/python/pythonProject/PHDfirstTest/x_iiot/WGAN/0_1939_wgan_generated_data.csv',
    encoding='utf-8',
    low_memory=False)
