function [Test_Result, Train_num_turns] = STWDSFNNAlgorithm_10folds(Train,Validate,Test,Para_Init,alpha,BatchSize,lambda)
...
% 保存实验结果
save([file_path_save  char(file_name_per)  '_STWDSFNN_Para_'  num2str(Para_Init.s) num2str(Para_Init.t)  '.mat'], ...
