function [Contrast_Result_A_temp, Contrast_Result_A_Mean_all,Contrast_Result_A_SE_all] = Result_Mean_SE(Contrast_Result)
...
Results_11111 = find(Results_vectors == 111111);
Results_22222 = find(Results_vectors == 222222);
d = Results_22222 - Results_11111 - 1;

Results_33333 = find(Results_vectors == 333333);
e = Results_33333 + d ;
...
if e == length(Results_vectors)
    ...
    Results_A = Results_vectors(1:7); % Test_Acc, Test_WeightF1, Test_Kappa, Test_Loss, Para_Init.Hidden_step
    Results_C = []; 
end
end