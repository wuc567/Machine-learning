function [Contrast_SFNN_TraiNums, Contrast_Result_matrix, Contrast_Result_Mean_all,Contrast_Result_SE_all] = Run_TWDSFNNAlgo_5folds(data, label, Para_Init, indices)
...
for k=1:5 %Para_Init.Data_epochs 
    ...
    [Test_Result, Train_num_turns] = arrayfun(@(p1,p2,p3) TWDSFNNAlgorithm_5folds(Train,Validate,Test,Para_Init,p1,p2,p3), Para_Optimize.alpha,Para_Optimize.BatchSize,Para_Optimize.lambda,'UniformOutput',false);  % 1*48  
