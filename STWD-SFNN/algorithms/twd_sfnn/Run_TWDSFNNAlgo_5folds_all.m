...
for i = 1:length(active_list)
    ...
    for j = 1:length(data_type)
        ...
        [Result_TraiNums, Result_matrix, Result_Mean,Result_SE] = Run_TWDSFNNAlgo_5folds(data, label, Para_Init, indices);
...
% 保存实验结果
save([file_path_save  char(file_name_per)  '_TWDSFNN_5folds_all'  '.mat'], 'Result_matrix_all','Result_train_all')
